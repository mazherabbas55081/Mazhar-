...
# ========== HEADER ==========
st.markdown('<div class="main-title">🎓 PAK NAVY POLYTECHNIC INSTITUTE</div>', unsafe_allow_html=True)
...
if page == "🏠 Home":
    ...
    c1.image("assets/campus.jpg", caption="College Building", use_container_width=True)
    c2.image("assets/classroom.jpg", caption="Classroom", use_container_width=True)
    c3.image("assets/canteen.jpg", caption="Students Canteen", use_container_width=True)
...
# ========== LABS ==========
    ...
    st.image("assets/lab.jpg",
             caption="Robot / Mechatronic Lab", use_container_width=True)
    st.markdown('<div class="section-header">🔧 Workshop Lab</div>', unsafe_allow_html=True)
    st.image("assets/lab2.jpg", caption="Workshop Lab", use_container_width=True)
    st.markdown('<div class="section-header">⚡ Electronics Lab</div>', unsafe_allow_html=True)
    st.image("assets/lab3.jpg", caption="Electronics Lab", use_container_width=True)
...
# ========== ABOUT ==========
    ...
    st.image("assets/logo.png", width=180, caption="PNPI Logo")
    st.image("assets/campus.jpg",
...
© 2024 All Rights Reserved | Made with ❤️ using Python & Streamlit
</div>""", unsafe_allow_html=True)
